...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-gradient-to-br from-slate-900 to-indigo-950 p-8 rounded-[2rem] text-white flex flex-col justify-between shadow-xl relative overflow-hidden">
        ...
        <div class="pt-6 border-t border-white/10 mt-6 z-10 flex gap-4">
            <button class="bg-white text-slate-950 font-bold px-5 py-2.5 rounded-xl text-xs hover:bg-slate-100 transition">Input Manual</button>
            <button class="text-white/80 hover:text-white font-semibold text-xs flex items-center gap-1">Lihat Pasien &rarr;</button>
        </div>
    </div>
</div>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [65, 32, 48],
                    backgroundColor: ['rgba(79, 70, 229, 0.85)','rgba(59, 130, 246, 0.85)','rgba(16, 185, 129, 0.85)'],
                    borderRadius: 12,
                    borderSkipped: false,
                }]
            },
